...
const STORAGE_KEY='digestive-exam-2020-v1';
...
function backupAnswers(){
 ...
 const url=URL.createObjectURL(blob),a=document.createElement('a');a.href=url;a.download='2020-실전풀이-답안.json';a.click();setTimeout(()=>URL.revokeObjectURL(url),1000);
}
